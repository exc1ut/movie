...
const SignIn: React.FC<Props> = () => {
    ...
    const [caseState, setCaseState] = useState("Sign In");
    const [checkBox, setCheckBox] = useState(false);
    const handleSocial = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
        e.preventDefault();
            ...
            <Box className={classes.box}>
                <Grid item className={classes.grid}>
                    <form action="" className={styles.Form}>
                        <Link to="/" className={styles.signLogo}>
                            <img src={Logo} alt="" />
                        ...
                        <div className={`${styles.formGroup} ${styles.formCheckbox}`}>
                            <input type="checkbox" id="remember"
                                onClick={handleRemember} className={styles.remember} />
                            <label htmlFor="remember"> Remember me </label>
                        </div>
                        <button className={styles.Button}>SIGN IN</button>
                        <span className={styles.delimiter}>or</span>
                        <div className={styles.Social}>
                            <a className={styles.facebook} onClick={handleSocial} href="">
                            ...
                            <a className={styles.twitter} onClick={handleSocial} href="">
                            ...
                            <a className={styles.google} onClick={handleSocial} href="">
